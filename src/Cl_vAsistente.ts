...
export default class Cl_vAsistente extends Cl_vGeneral {
  ...
  private selEstado: HTMLSelectElement; 
  ...
  private asistente: Cl_mAsistente;
  ...
  constructor() {
    ...
    this.inNombre = this.crearHTMLInputElement("inNombre", {
      ...
      refresh: () =>
        (this.inNombre.style.borderColor = this.asistente.nombreOk ? "" : "red"),
    });
    ...
    this.inTelefono = this.crearHTMLInputElement("inTelefono", {
      ...
      refresh: () =>
        (this.inTelefono.style.borderColor = this.asistente.telefonoOk ? "" : "red"),
    });
    ...
    this.inCorreo = this.crearHTMLInputElement("inCorreo", {
      ...
      refresh: () =>
        (this.inCorreo.style.borderColor = this.asistente.correoOk ? "" : "red"),
    });
  ...
  aceptar() {
    if (this.opcion === opcionFicha.add) {
      this.controlador!.addAsistente({
        ...
        callback: (error) => {
          if (!error) this.controlador!.activarVista({ vista: "asistentes" });
