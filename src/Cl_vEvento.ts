...
export default class Cl_vEvento extends Cl_vGeneral {
  private vInicio: Cl_vInicio;
  private vUsuario: Cl_vUsuario;
  private vAdmin: Cl_vAdmin;
  private vAsistentes: Cl_vAsistentes;
  private vAsistente: Cl_vAsistente;
  private vEstadisticas: Cl_vEstadisticas;
  ...
  private ocultarTodasLasVistas(): void {
